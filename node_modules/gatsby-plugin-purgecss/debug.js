...
function writeConfig(config) {
    ...
    try {
        fs_extra_1.default.writeFileSync('gatsby-plugin-purgecss-debug-config.js', util_1.inspect(config, { depth: 15 }), 'utf8');
        return 0;
    }
    catch (error) {
...
function writeAppendError(errorMessage) {
    ...
    try {
        fs_extra_1.default.appendFileSync('gatsby-plugin-purgecss-debug.js', util_1.inspect(errorMessage), 'utf8');
        return 0;
    }
    catch (error) {
        console.log('\nCould not write file.');
